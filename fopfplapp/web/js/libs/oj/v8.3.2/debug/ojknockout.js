 ...
 * @private
 */
oj.ComponentBinding.prototype._init =
 ...
 * @private
 */
oj.ComponentBinding.prototype._update =
  function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
...
oj.ComponentBinding.prototype._initComponent = function (element, ctx) {
  ...
  var managedAttrMap =
      oj.ComponentBinding._resolveManagedAttributes(this._managedAttrOptions,
...
oj.ComponentBinding.prototype._getManagedAttributes = function (specifiedOptions, componentName) {
  return oj.ComponentBinding._resolveManagedAttributes(this._managedAttrOptions,
                                                       specifiedOptions,
                                                       componentName);
};
 ...
 * @private
 */
oj.ComponentBinding._resolveManagedAttributes =
 ...
 * @private
 */
oj.ComponentBinding._writeValueToProperty = function (
...
oj.Object.createSubclass(ComponentChangeTracker, oj.Object,
...
BindingProviderImpl.addPostprocessor(
  {
    nodeHasBindings: function (node, wrappedReturn) {
      ...
      return wrappedReturn ||
        (node.nodeType === 1 && oj.BaseCustomElementBridge.getRegistered(node.nodeName));
    },
...
(function () {
        ...
        if (node.nodeType === 1) {
          ...
          if (boundAttrs) {
            ...
            for (i = 0; i < boundAttrs.length; i++) {
              ...
              if (attr === 'class') {
                _setClassEvaluator(wrappedReturn, attrEvaluators, node,
  ...
  function _getValueEvaluator(elem, attr, value, bindingContext, type) {
    ...
    if (exp == null) {
      return function () {
        return type === 'object' ?
          oj.__AttributeUtils.coerceValue(elem, attr, value, type) :
          value;
      };
    }
  ...
  function _getBindings(node) {
    ...
    if (!node[_BINDINGS]) {
      ...
      var isCustomElement = (oj.BaseCustomElementBridge ?
                             !!oj.BaseCustomElementBridge.getRegistered(node.nodeName) :
                             false);
...
(function () {
  ...
  OjForEach.prototype.getDataMutationHelper = function (event, promiseContainer) {
    ...
    if (addDetail) {
      ...
      dataIndexes = this.getIndexesForEvent(addDetail.indexes,
