...
var AsyncRegExpValidator = /*#__PURE__*/function (_SyncValidatorAdapter) {
  _inherits(AsyncRegExpValidator, _SyncValidatorAdapter);

  var _super = _createSuper(AsyncRegExpValidator);

  function AsyncRegExpValidator(options) {
    var _this;

    _classCallCheck(this, AsyncRegExpValidator);
  ...
  _createClass(AsyncRegExpValidator, [{
    ...
    key: "hint",
    get: function get() {
      return _get(_getPrototypeOf(AsyncRegExpValidator.prototype), "_GetHint", this).call(this);
    }
  }]);
