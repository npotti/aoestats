...
oj.__registerWidget('oj.ojTimeline', $.oj.dvtTimeComponent, {
  ...
  _ProcessStyles: function _ProcessStyles() {
    ...
    if (!this.options.styleDefaults.series.colors) {
      var handler = new attributeGroupHandler.ColorAttributeGroupHandler(); // override default colors with css attribute group colors
  ...
  _GetChildStyleClasses: function _GetChildStyleClasses() {
    ...
    styleClasses['oj-timeline'] = {
      path: 'styleDefaults/borderColor',
      property: 'border-color'
    };
    styleClasses['oj-timeline-item'] = [{
      path: 'styleDefaults/item/borderColor',
      property: 'border-color'
    }, {
      path: 'styleDefaults/item/backgroundColor',
      property: 'background-color'
    }];
    styleClasses['oj-timeline-item oj-hover'] = [{
      path: 'styleDefaults/item/hoverBorderColor',
      property: 'border-color'
    }, {
      path: 'styleDefaults/item/hoverBackgroundColor',
      property: 'background-color'
    }];
    styleClasses['oj-timeline-item oj-selected'] = [{
      path: 'styleDefaults/item/selectedBorderColor',
      property: 'border-color'
    }, {
      path: 'styleDefaults/item/selectedBackgroundColor',
      property: 'background-color'
    }];
    ...
    styleClasses['oj-timeline-minor-axis'] = [{
      path: 'styleDefaults/minorAxis/backgroundColor',
      property: 'background-color'
    }, {
      path: 'styleDefaults/minorAxis/borderColor',
      property: 'border-color'
    }];
    ...
    styleClasses['oj-timeline-overview-window'] = [{
      path: 'styleDefaults/overview/window/backgroundColor',
      property: 'background-color'
    }, {
      path: 'styleDefaults/overview/window/borderColor',
      property: 'border-color'
    }];
  ...
  _LoadResources: function _LoadResources() {
    ...
    var converter = resources.converter; // Create default converters for vertical timeline
...
(function () {
  ...
  oj.CustomElementBridge.register('oj-timeline', {
    metadata: __oj_timeline_metadata
  });
})();
